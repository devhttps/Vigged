...
?>
    ...
    <section class="py-16 bg-purple-600 text-white">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-4xl font-bold text-center mb-12">Nosso Impacto</h2>
            <div class="grid md:grid-cols-4 gap-8 text-center">
                <div>
                    <div class="text-5xl font-bold mb-2">5.000+</div>
                    <div class="text-purple-200">Profissionais PCD Cadastrados</div>
                </div>
                <div>
                    <div class="text-5xl font-bold mb-2">500+</div>
                    <div class="text-purple-200">Empresas Parceiras</div>
                </div>
                <div>
                    <div class="text-5xl font-bold mb-2">2.000+</div>
                    <div class="text-purple-200">Vagas Publicadas</div>
                </div>
                <div>
                    <div class="text-5xl font-bold mb-2">1.500+</div>
                    <div class="text-purple-200">Contratações Realizadas</div>
                </div>
            </div>
        </div>
    </section>
